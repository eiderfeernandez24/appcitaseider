<template>
    <div class="container text-center py-5">
      <h2 class="">Bienvenido a Matchify</h2>
  ...
  .btn-light {
    ...
    font-size: 14px; /* Hacer los botones más pequeños */
  ...
  /* Ajustar botones en dos columnas */
  .row.g-4 {
    display: flex;
    flex-wrap: wrap;
    justify-content: center; /* Centrar las dos columnas */
  }
